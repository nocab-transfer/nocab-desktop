              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: Text(isDownload
                      ? 'mainView.transfers.card.transferSuccess.receiverSuccess'.plural(state.files.length, name: 'count')
                      : 'mainView.transfers.card.transferSuccess.senderSuccess'.plural(state.files.length, name: 'count')),
                ),
              ),
              Padding(
                padding: const EdgeInsets.all(8.0),
